    ...
    <div className={`site-shell${siteReady ? " site-shell--ready" : " site-shell--loading"}`}>
      ...
      <header className="site-header">
        <a className="brand-lockup" href="#top" aria-label="CookeByte home" onClick={closeMenu}>
          <img className="cookebyte-header-logo" src="/manus-storage/cookebyte-header-logo-transparent_a4848b44.png" alt="CookeByte" />
        </a>
            ...
            <div className="private-panel-content">
              ...
              <div className="contact-popup-list">
                {contactPopup === "whatsapp" ? (
                  <>
                    <a className="contact-popup-card contact-popup-card--lime mono-glitch" href="https://wa.me/916381914606?text=Hi%20Benitto%2C%20I%20found%20CookeByte%20and%20would%20like%20to%20discuss%20a%20project." target="_blank" rel="noreferrer">
                      <span><small>01 / DEVELOPMENT LEAD</small><strong>Benitto Joshua</strong><em>+91 638 191 4606</em></span><ArrowUpRightIcon />
                    </a>
                    <a className="contact-popup-card contact-popup-card--orange mono-glitch" href="https://wa.me/918903346957?text=Hi%20Abisheik%2C%20I%20found%20CookeByte%20and%20would%20like%20to%20discuss%20a%20project." target="_blank" rel="noreferrer">
                      <span><small>02 / VISUAL LEAD</small><strong>Abisheik</strong><em>+91 890 334 6957</em></span><ArrowUpRightIcon />
                    </a>
                  </>
                ) : (
                  <>
                    <a className="contact-popup-card contact-popup-card--ink mono-glitch" href="tel:+916381914606">
                      <span><small>01 / DEVELOPMENT LEAD</small><strong>Benitto Joshua</strong><em>+91 638 191 4606</em></span><ArrowUpRightIcon />
                    </a>
                    <a className="contact-popup-card contact-popup-card--ink mono-glitch" href="tel:+918903346957">
                      <span><small>02 / VISUAL LEAD</small><strong>Abisheik</strong><em>+91 890 334 6957</em></span><ArrowUpRightIcon />
                    </a>
                  </>
                )}
